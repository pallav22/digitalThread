...
/**
 * @class Unit test spec for map-popovers.
 *
...
define(['jquery', 'map-markers-component/map-markers', 'map-popovers', 'map-core-component/map-core', 'OpenLayers', 'modernizr'], function ($, mapMarkers) {

  describe('There should be a marker on map and be able to launch a popover from it.', function(){
    ...
    before(function(done){
      ...
      mapMarkers.addMarkers(this.data, this.olMap, markerOptions, 'Address Markers').done(function(){
        done();
      })
    });
